...
***2. Правила за всички текстови канали***
...
**3.7.** Прекомерното нарушаване на правилата на сървъра може да доведе до последствия.
...
**3.8.** След като влезете в сървъра, вие автоматично се съгласявате и приемате правилата / позицията на сървъра.
